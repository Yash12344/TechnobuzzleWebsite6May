...
const LINKS = ["Work", "Process", "Marketing AI", "Studio", "Careers", "Contact"];
const SOCIAL = [
        ...
        <div className="grid grid-cols-12 gap-10 border-b border-bg/10 pb-16">
          <div className="col-span-12 md:col-span-5">
            ...
            <p className="mt-6 max-w-md text-bg/65">
              A results-driven digital marketing agency in Dehradun, helping
              brands grow with SEO, social, paid media and high-converting
              websites.
            </p>

            <a
              href="mailto:teamtechnobuzzle@gmail.com"
              data-cursor="hover"
              className="mt-8 inline-flex items-center gap-3 text-2xl font-anton uppercase tracking-tight md:text-4xl"
            >
              <span className="scribble-underline">teamtechnobuzzle@gmail.com</span>
