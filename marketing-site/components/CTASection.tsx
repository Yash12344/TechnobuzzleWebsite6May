        ...
        <div className="relative isolate overflow-hidden rounded-[2rem] bg-electric p-8 text-bg md:p-16">
          ...
          <div className="relative grid grid-cols-12 gap-8">
            <div className="col-span-12 lg:col-span-7">
              ...
              <div className="mt-12 grid grid-cols-2 gap-6 border-t border-bg/20 pt-6 md:grid-cols-3">
                <div>
                  ...
                  <div className="mt-1 font-anton text-lg">
            ...
            <div className="relative col-span-12 lg:col-span-5">
              ...
              >
                <Image
                  src="https://loremflickr.com/900/1100/indian,woman,professional/all?lock=12"
                  alt="Indian marketing professional ready to collaborate"
                  fill
                  unoptimized
