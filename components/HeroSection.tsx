      ...
      <div className="relative mx-auto max-w-[1500px] px-5 md:px-8 lg:px-12">
        ...
        >
          <span className="inline-flex items-center gap-2">
            ...
            AI-Powered Creative Growth Agency
          </span>
          <span className="hidden md:inline">Est. 2019 — Worldwide / Remote</span>
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          >
            ...
            >
              Technobuzzle is an{" "}
              <span className="text-ink">AI-native creative studio</span>{" "}
              engineering category-defining brands. We fuse cinematic
              storytelling with intelligent systems to ship work that scales —
              and dominates.
            </motion.p>
