...
const SERVICES = [
  {
    ...
    desc: "Identity systems, positioning, and brand books built to compound.",
    Icon: Brush,
    image:
  ...
  },
  {
    ...
    desc: "Always-on social ecosystems engineered for community and reach.",
    Icon: Megaphone,
    image:
  ...
  },
  {
    ...
    desc: "Cinematic shoots, editorial design and CGI that move the metric.",
    Icon: Film,
    image:
  ...
  },
  {
    ...
    desc: "Awwwards-grade sites and products that convert and scale.",
    Icon: Code2,
    image:
  ...
  },
  {
    ...
    desc: "Full-funnel paid systems with creative testing as the engine.",
    Icon: TrendingUp,
    image:
      "https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=900&q=80",
    tags: ["Meta", "Google", "Programmatic"],
  },
  {
    n: "06",
    title: "AI Automation & Solutions",
    desc: "Custom AI agents and workflows that compress operations 10×.",
    Icon: Sparkles,
    image:
