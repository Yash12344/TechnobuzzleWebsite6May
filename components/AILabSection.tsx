        ...
        <div className="grid grid-cols-12 gap-10 lg:gap-16">
          ...
          <div className="col-span-12 lg:col-span-6">
            ...
            >
              Intelligent <br />
              solutions for <br />
              <span className="text-stroke-white">the future.</span>
            </motion.h2>
          ...
          <div className="col-span-12 lg:col-span-6">
            ...
            >
              We don&apos;t bolt AI onto agency work — we engineer it into the
              core. The result: brands that learn, adapt and out-compound the
              market.
            </motion.p>
